...
class test_source(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_article = Article("Simon Hill","Favorite learning language","Learning a new tongue? Its a worthy pursuit, and these WIRED-tested services can help.", "https://www.wired.com/gallery/best-language-learning-apps/","https://media.wired.com/photos/62474a8a73b639a714b7f2b1/191:100/w_2580,c_limit/Babbel-App-Featured-Gear.jpg")
